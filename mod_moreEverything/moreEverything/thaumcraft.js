...
(function ()
{
  if (mods.thaumcraft)
  {
    ...
    {
      RegisterObjectTag(FindIntMatch(/I:stoneInert=(\d+)/), -1, "magic", 4, "rock", 8);
      RegisterObjectTag(FindIntMatch(/I:stoneMinium=(\d+)/), -1, "magic", 8, "rock", 8, "power", 8, "exchange", 8);
      RegisterObjectTag(FindIntMatch(/I:shardMinium=(\d+)/), -1, "power", 1, "evil", 1);
    }
